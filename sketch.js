...
var boyCharacter, boyCharacter_img;
var maze, maze_img;
var snake, scorpion;
...
function preload()
{
  ...
  boyCharacter_img = loadImage("boyCharacter.png");
}
...
function setup() {
  ...
  boyCharacter = createSprite(80,400,30,30);
  boyCharacter.addImage(boyCharacter_img);
  boyCharacter.scale = 0.09;
